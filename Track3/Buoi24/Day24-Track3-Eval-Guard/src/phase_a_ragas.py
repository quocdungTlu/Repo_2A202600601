...
# Compatibility shim: langchain >= 1.x removed langchain.pydantic_v1
# RAGAS 0.1.x still imports from there; redirect to langchain_core.pydantic_v1
try:
    ...
    sys.modules["langchain.pydantic_v1"] = _pv1
