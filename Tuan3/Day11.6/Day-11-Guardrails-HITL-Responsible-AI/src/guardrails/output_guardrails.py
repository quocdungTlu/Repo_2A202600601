...
from core.config import MODEL_NAME, PII_PATTERNS
from core.utils import chat_with_agent, extract_text


# Compile once at import time — content_filter runs on every LLM response.
_PII_RE = {
...
class OutputGuardrailPlugin(base_plugin.BasePlugin):
    ...
    def _extract_text(self, llm_response) -> str:
        ...
        return extract_text(getattr(llm_response, "content", None))
